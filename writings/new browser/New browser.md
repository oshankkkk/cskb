...
---
### My browser timeline
So i used chrome for all my life until i started using vim. After that i switched to qutebrowser cause it supported the vim keymaps by default. I fukin love everything bout qutebrowser except for the fact that it does not have adblocking.
